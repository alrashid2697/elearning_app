...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card text-white bg-info mb-3 mx-auto" style="max-width:25rem;">
                <div class="card-body">
        ...
        <div class="col-md-12">
            <a href="{{url('/admin/createcategory')}}" class="btn btn-success float-right my-2" role="button">
